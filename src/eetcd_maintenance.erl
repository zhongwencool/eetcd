...
-spec alarm_list(new_context()) ->
    {ok,rpc_pb:'etcdserverpb.AlarmResponse'()}|{error,eetcd_error()}.
alarm_list(ConnName) ->
...
-spec alarm_disarm_all(new_context()) ->
    rpc_pb:'etcdserverpb.AlarmResponse'().
...
-spec defragment(iodata(), eetcd:opts()) ->
    {ok,rpc_pb:'etcdserverpb.DefragmentResponse'()}|{error,eetcd_error()}.
...
-spec status(iodata(), eetcd:opts()) ->
    {ok,rpc_pb:'etcdserverpb.StatusResponse'()}|{error,eetcd_error()}.
...
-spec hash_kv(iodata(), eetcd:opts(), pos_integer()) ->
    {ok,rpc_pb:'etcdserverpb.HashKVResponse'()}|{error,eetcd_error()}.
...
-spec move_leader(new_context(), pos_integer()) ->
    {ok,rpc_pb:'etcdserverpb.MoveLeaderResponse'()}|{error,eetcd_error()}.
