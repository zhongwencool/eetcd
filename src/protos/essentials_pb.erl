...
-export(['enum_symbol_by_value_eetcd.Event.EventType'/1, 'enum_value_by_symbol_eetcd.Event.EventType'/1]).
...
%% enumerated types
-type 'eetcd.Event.EventType'() :: 'PUT' | 'DELETE'.
...
-export_type(['eetcd.Event.EventType'/0, 'google.protobuf.FieldDescriptorProto.Type'/0, 'google.protobuf.FieldDescriptorProto.Label'/0, 'google.protobuf.FileOptions.OptimizeMode'/0, 'google.protobuf.FieldOptions.CType'/0, 'google.protobuf.FieldOptions.JSType'/0]).

%% message types
-type 'eetcd.ResponseHeader'() ::
...
-type 'eetcd.HashRequest'() ::
      #{
       }.

-type 'eetcd.HashKVRequest'() ::
      #{revision                => integer()        % = 1, 32 bits
       }.

-type 'eetcd.HashKVResponse'() ::
      #{header                  => 'eetcd.ResponseHeader'(), % = 1
        hash                    => non_neg_integer(), % = 2, 32 bits
        compact_revision        => integer()        % = 3, 32 bits
       }.

-type 'eetcd.HashResponse'() ::
      #{header                  => 'eetcd.ResponseHeader'(), % = 1
        hash                    => non_neg_integer() % = 2, 32 bits
       }.
...
-type 'eetcd.Event'() ::
      #{type                    => 'PUT' | 'DELETE' | integer(), % = 1, enum eetcd.Event.EventType
        kv                      => 'eetcd.KeyValue'(), % = 2
        prev_kv                 => 'eetcd.KeyValue'() % = 3
       }.
...
encode_msg(Msg, MsgName, Opts) ->
    ...
    case MsgName of
      'eetcd.ResponseHeader' ->
	  'encode_msg_eetcd.ResponseHeader'(id(Msg, TrUserData),
					    TrUserData);
      'eetcd.HashRequest' ->
	  'encode_msg_eetcd.HashRequest'(id(Msg, TrUserData),
					 TrUserData);
      'eetcd.HashKVRequest' ->
	  'encode_msg_eetcd.HashKVRequest'(id(Msg, TrUserData),
					   TrUserData);
      'eetcd.HashKVResponse' ->
	  'encode_msg_eetcd.HashKVResponse'(id(Msg, TrUserData),
					    TrUserData);
      'eetcd.HashResponse' ->
	  'encode_msg_eetcd.HashResponse'(id(Msg, TrUserData),
					  TrUserData);
      'eetcd.KeyValue' ->
	  'encode_msg_eetcd.KeyValue'(id(Msg, TrUserData),
				      TrUserData);
      'eetcd.Event' ->
	  'encode_msg_eetcd.Event'(id(Msg, TrUserData),
				   TrUserData);
...
'encode_msg_eetcd.ResponseHeader'(Msg, TrUserData) ->
    'encode_msg_eetcd.ResponseHeader'(Msg, <<>>,
				      TrUserData).


'encode_msg_eetcd.ResponseHeader'(#{} = M, Bin,
				  TrUserData) ->
    B1 = case M of
	   #{cluster_id := F1} ->
	       begin
...
'encode_msg_eetcd.HashRequest'(_Msg, _TrUserData) ->
    <<>>.

'encode_msg_eetcd.HashKVRequest'(Msg, TrUserData) ->
    'encode_msg_eetcd.HashKVRequest'(Msg, <<>>, TrUserData).


'encode_msg_eetcd.HashKVRequest'(#{} = M, Bin,
				 TrUserData) ->
    case M of
      #{revision := F1} ->
	  begin
...
'encode_msg_eetcd.HashKVResponse'(Msg, TrUserData) ->
    'encode_msg_eetcd.HashKVResponse'(Msg, <<>>,
				      TrUserData).


'encode_msg_eetcd.HashKVResponse'(#{} = M, Bin,
				  TrUserData) ->
    B1 = case M of
	   #{header := F1} ->
	       begin
		 ...
		 if TrF1 =:= undefined -> Bin;
		    true ->
			'e_mfield_eetcd.HashKVResponse_header'(TrF1,
							       <<Bin/binary,
								 10>>,
							       TrUserData)
		 end
...
'encode_msg_eetcd.HashResponse'(Msg, TrUserData) ->
    'encode_msg_eetcd.HashResponse'(Msg, <<>>, TrUserData).


'encode_msg_eetcd.HashResponse'(#{} = M, Bin,
				TrUserData) ->
    B1 = case M of
	   #{header := F1} ->
	       begin
		 ...
		 if TrF1 =:= undefined -> Bin;
		    true ->
			'e_mfield_eetcd.HashResponse_header'(TrF1,
							     <<Bin/binary, 10>>,
							     TrUserData)
		 end
	       end;
...
'encode_msg_eetcd.KeyValue'(Msg, TrUserData) ->
    'encode_msg_eetcd.KeyValue'(Msg, <<>>, TrUserData).


'encode_msg_eetcd.KeyValue'(#{} = M, Bin, TrUserData) ->
    B1 = case M of
	   #{key := F1} ->
	       begin
		 TrF1 = id(F1, TrUserData),
...
'encode_msg_eetcd.Event'(Msg, TrUserData) ->
    'encode_msg_eetcd.Event'(Msg, <<>>, TrUserData).


'encode_msg_eetcd.Event'(#{} = M, Bin, TrUserData) ->
    B1 = case M of
	   #{type := F1} ->
	       begin
		 TrF1 = id(F1, TrUserData),
		 if TrF1 =:= 'PUT'; TrF1 =:= 0 -> Bin;
		    true ->
			'e_enum_eetcd.Event.EventType'(TrF1, <<Bin/binary, 8>>,
						       TrUserData)
		 end
	       end;
	   _ -> Bin
    ...
    B2 = case M of
	   #{kv := F2} ->
		 ...
		 if TrF2 =:= undefined -> B1;
		    true ->
			'e_mfield_eetcd.Event_kv'(TrF2, <<B1/binary, 18>>,
						  TrUserData)
		 end
	       end;
	   _ -> B1
    ...
    case M of
	  ...
	  begin
	    ...
	    if TrF3 =:= undefined -> B2;
	       true ->
		   'e_mfield_eetcd.Event_prev_kv'(TrF3, <<B2/binary, 26>>,
						  TrUserData)
	    end
	  end;
      _ -> B2
...
'e_mfield_eetcd.HashKVResponse_header'(Msg, Bin,
				       TrUserData) ->
    SubBin = 'encode_msg_eetcd.ResponseHeader'(Msg, <<>>,
					       TrUserData),
    Bin2 = e_varint(byte_size(SubBin), Bin),
    <<Bin2/binary, SubBin/binary>>.

'e_mfield_eetcd.HashResponse_header'(Msg, Bin,
				     TrUserData) ->
    SubBin = 'encode_msg_eetcd.ResponseHeader'(Msg, <<>>,
					       TrUserData),
    Bin2 = e_varint(byte_size(SubBin), Bin),
...
'e_mfield_eetcd.Event_kv'(Msg, Bin, TrUserData) ->
    SubBin = 'encode_msg_eetcd.KeyValue'(Msg, <<>>,
					 TrUserData),
    Bin2 = e_varint(byte_size(SubBin), Bin),
    <<Bin2/binary, SubBin/binary>>.

'e_mfield_eetcd.Event_prev_kv'(Msg, Bin, TrUserData) ->
    SubBin = 'encode_msg_eetcd.KeyValue'(Msg, <<>>,
					 TrUserData),
    Bin2 = e_varint(byte_size(SubBin), Bin),
    <<Bin2/binary, SubBin/binary>>.
...
'e_enum_eetcd.Event.EventType'('PUT', Bin,
			       _TrUserData) ->
    <<Bin/binary, 0>>;
'e_enum_eetcd.Event.EventType'('DELETE', Bin,
			       _TrUserData) ->
    <<Bin/binary, 1>>;
'e_enum_eetcd.Event.EventType'(V, Bin, _TrUserData) ->
    e_varint(V, Bin).
...
decode_msg_2_doit('eetcd.ResponseHeader', Bin,
		  TrUserData) ->
    id('decode_msg_eetcd.ResponseHeader'(Bin, TrUserData),
       TrUserData);
decode_msg_2_doit('eetcd.HashRequest', Bin,
		  TrUserData) ->
    id('decode_msg_eetcd.HashRequest'(Bin, TrUserData),
       TrUserData);
decode_msg_2_doit('eetcd.HashKVRequest', Bin,
		  TrUserData) ->
    id('decode_msg_eetcd.HashKVRequest'(Bin, TrUserData),
       TrUserData);
decode_msg_2_doit('eetcd.HashKVResponse', Bin,
		  TrUserData) ->
    id('decode_msg_eetcd.HashKVResponse'(Bin, TrUserData),
       TrUserData);
decode_msg_2_doit('eetcd.HashResponse', Bin,
		  TrUserData) ->
    id('decode_msg_eetcd.HashResponse'(Bin, TrUserData),
       TrUserData);
decode_msg_2_doit('eetcd.KeyValue', Bin, TrUserData) ->
    id('decode_msg_eetcd.KeyValue'(Bin, TrUserData),
       TrUserData);
decode_msg_2_doit('eetcd.Event', Bin, TrUserData) ->
    id('decode_msg_eetcd.Event'(Bin, TrUserData),
       TrUserData);
...
'decode_msg_eetcd.ResponseHeader'(Bin, TrUserData) ->
    'dfp_read_field_def_eetcd.ResponseHeader'(Bin, 0, 0,
					      id(0, TrUserData),
					      id(0, TrUserData),
					      id(0, TrUserData),
					      id(0, TrUserData), TrUserData).

'dfp_read_field_def_eetcd.ResponseHeader'(<<8,
					    Rest/binary>>,
					  Z1, Z2, F@_1, F@_2, F@_3, F@_4,
					  TrUserData) ->
    'd_field_eetcd.ResponseHeader_cluster_id'(Rest, Z1, Z2,
					      F@_1, F@_2, F@_3, F@_4,
					      TrUserData);
'dfp_read_field_def_eetcd.ResponseHeader'(<<16,
					    Rest/binary>>,
					  Z1, Z2, F@_1, F@_2, F@_3, F@_4,
					  TrUserData) ->
    'd_field_eetcd.ResponseHeader_member_id'(Rest, Z1, Z2,
					     F@_1, F@_2, F@_3, F@_4,
					     TrUserData);
'dfp_read_field_def_eetcd.ResponseHeader'(<<24,
					    Rest/binary>>,
					  Z1, Z2, F@_1, F@_2, F@_3, F@_4,
					  TrUserData) ->
    'd_field_eetcd.ResponseHeader_revision'(Rest, Z1, Z2,
					    F@_1, F@_2, F@_3, F@_4, TrUserData);
'dfp_read_field_def_eetcd.ResponseHeader'(<<32,
					    Rest/binary>>,
					  Z1, Z2, F@_1, F@_2, F@_3, F@_4,
					  TrUserData) ->
    'd_field_eetcd.ResponseHeader_raft_term'(Rest, Z1, Z2,
					     F@_1, F@_2, F@_3, F@_4,
					     TrUserData);
'dfp_read_field_def_eetcd.ResponseHeader'(<<>>, 0, 0,
					  F@_1, F@_2, F@_3, F@_4, _) ->
    #{cluster_id => F@_1, member_id => F@_2,
      revision => F@_3, raft_term => F@_4};
'dfp_read_field_def_eetcd.ResponseHeader'(Other, Z1, Z2,
					  F@_1, F@_2, F@_3, F@_4, TrUserData) ->
    'dg_read_field_def_eetcd.ResponseHeader'(Other, Z1, Z2,
					     F@_1, F@_2, F@_3, F@_4,
					     TrUserData).

'dg_read_field_def_eetcd.ResponseHeader'(<<1:1, X:7,
					   Rest/binary>>,
					 N, Acc, F@_1, F@_2, F@_3, F@_4,
					 TrUserData)
    when N < 32 - 7 ->
    'dg_read_field_def_eetcd.ResponseHeader'(Rest, N + 7,
					     X bsl N + Acc, F@_1, F@_2, F@_3,
					     F@_4, TrUserData);
'dg_read_field_def_eetcd.ResponseHeader'(<<0:1, X:7,
					   Rest/binary>>,
					 N, Acc, F@_1, F@_2, F@_3, F@_4,
					 TrUserData) ->
    Key = X bsl N + Acc,
    case Key of
      8 ->
	  'd_field_eetcd.ResponseHeader_cluster_id'(Rest, 0, 0,
						    F@_1, F@_2, F@_3, F@_4,
						    TrUserData);
      16 ->
	  'd_field_eetcd.ResponseHeader_member_id'(Rest, 0, 0,
						   F@_1, F@_2, F@_3, F@_4,
						   TrUserData);
      24 ->
	  'd_field_eetcd.ResponseHeader_revision'(Rest, 0, 0,
						  F@_1, F@_2, F@_3, F@_4,
						  TrUserData);
      32 ->
	  'd_field_eetcd.ResponseHeader_raft_term'(Rest, 0, 0,
						   F@_1, F@_2, F@_3, F@_4,
						   TrUserData);
      _ ->
	  case Key band 7 of
	    0 ->
		'skip_varint_eetcd.ResponseHeader'(Rest, 0, 0, F@_1,
						   F@_2, F@_3, F@_4,
						   TrUserData);
	    1 ->
		'skip_64_eetcd.ResponseHeader'(Rest, 0, 0, F@_1, F@_2,
					       F@_3, F@_4, TrUserData);
	    2 ->
		'skip_length_delimited_eetcd.ResponseHeader'(Rest, 0, 0,
							     F@_1, F@_2, F@_3,
							     F@_4, TrUserData);
	    3 ->
		'skip_group_eetcd.ResponseHeader'(Rest, Key bsr 3, 0,
						  F@_1, F@_2, F@_3, F@_4,
						  TrUserData);
	    5 ->
		'skip_32_eetcd.ResponseHeader'(Rest, 0, 0, F@_1, F@_2,
					       F@_3, F@_4, TrUserData)
	  end
    end;
'dg_read_field_def_eetcd.ResponseHeader'(<<>>, 0, 0,
					 F@_1, F@_2, F@_3, F@_4, _) ->
    #{cluster_id => F@_1, member_id => F@_2,
      revision => F@_3, raft_term => F@_4}.

'd_field_eetcd.ResponseHeader_cluster_id'(<<1:1, X:7,
					    Rest/binary>>,
					  N, Acc, F@_1, F@_2, F@_3, F@_4,
					  TrUserData)
    when N < 57 ->
    'd_field_eetcd.ResponseHeader_cluster_id'(Rest, N + 7,
					      X bsl N + Acc, F@_1, F@_2, F@_3,
					      F@_4, TrUserData);
'd_field_eetcd.ResponseHeader_cluster_id'(<<0:1, X:7,
					    Rest/binary>>,
					  N, Acc, _, F@_2, F@_3, F@_4,
					  TrUserData) ->
    {NewFValue, RestF} = {id(X bsl N + Acc, TrUserData),
			  Rest},
    'dfp_read_field_def_eetcd.ResponseHeader'(RestF, 0, 0,
					      NewFValue, F@_2, F@_3, F@_4,
					      TrUserData).

'd_field_eetcd.ResponseHeader_member_id'(<<1:1, X:7,
					   Rest/binary>>,
					 N, Acc, F@_1, F@_2, F@_3, F@_4,
					 TrUserData)
    when N < 57 ->
    'd_field_eetcd.ResponseHeader_member_id'(Rest, N + 7,
					     X bsl N + Acc, F@_1, F@_2, F@_3,
					     F@_4, TrUserData);
'd_field_eetcd.ResponseHeader_member_id'(<<0:1, X:7,
					   Rest/binary>>,
...
'd_field_eetcd.ResponseHeader_revision'(<<1:1, X:7,
					  Rest/binary>>,
					N, Acc, F@_1, F@_2, F@_3, F@_4,
					TrUserData)
    when N < 57 ->
    'd_field_eetcd.ResponseHeader_revision'(Rest, N + 7,
					    X bsl N + Acc, F@_1, F@_2, F@_3,
					    F@_4, TrUserData);
'd_field_eetcd.ResponseHeader_revision'(<<0:1, X:7,
					  Rest/binary>>,
...
'd_field_eetcd.ResponseHeader_raft_term'(<<1:1, X:7,
					   Rest/binary>>,
					 N, Acc, F@_1, F@_2, F@_3, F@_4,
					 TrUserData)
    when N < 57 ->
    'd_field_eetcd.ResponseHeader_raft_term'(Rest, N + 7,
					     X bsl N + Acc, F@_1, F@_2, F@_3,
					     F@_4, TrUserData);
'd_field_eetcd.ResponseHeader_raft_term'(<<0:1, X:7,
					   Rest/binary>>,
...
'skip_varint_eetcd.ResponseHeader'(<<1:1, _:7,
				     Rest/binary>>,
				   Z1, Z2, F@_1, F@_2, F@_3, F@_4,
				   TrUserData) ->
    'skip_varint_eetcd.ResponseHeader'(Rest, Z1, Z2, F@_1,
				       F@_2, F@_3, F@_4, TrUserData);
'skip_varint_eetcd.ResponseHeader'(<<0:1, _:7,
				     Rest/binary>>,
				   Z1, Z2, F@_1, F@_2, F@_3, F@_4,
				   TrUserData) ->
    'dfp_read_field_def_eetcd.ResponseHeader'(Rest, Z1, Z2,
					      F@_1, F@_2, F@_3, F@_4,
					      TrUserData).

'skip_length_delimited_eetcd.ResponseHeader'(<<1:1, X:7,
					       Rest/binary>>,
					     N, Acc, F@_1, F@_2, F@_3, F@_4,
					     TrUserData)
    when N < 57 ->
    'skip_length_delimited_eetcd.ResponseHeader'(Rest,
						 N + 7, X bsl N + Acc, F@_1,
						 F@_2, F@_3, F@_4, TrUserData);
'skip_length_delimited_eetcd.ResponseHeader'(<<0:1, X:7,
					       Rest/binary>>,
					     N, Acc, F@_1, F@_2, F@_3, F@_4,
					     TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    'dfp_read_field_def_eetcd.ResponseHeader'(Rest2, 0, 0,
					      F@_1, F@_2, F@_3, F@_4,
					      TrUserData).

'skip_group_eetcd.ResponseHeader'(Bin, FNum, Z2, F@_1,
				  F@_2, F@_3, F@_4, TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    'dfp_read_field_def_eetcd.ResponseHeader'(Rest, 0, Z2,
					      F@_1, F@_2, F@_3, F@_4,
					      TrUserData).

'skip_32_eetcd.ResponseHeader'(<<_:32, Rest/binary>>,
			       Z1, Z2, F@_1, F@_2, F@_3, F@_4, TrUserData) ->
    'dfp_read_field_def_eetcd.ResponseHeader'(Rest, Z1, Z2,
					      F@_1, F@_2, F@_3, F@_4,
					      TrUserData).

'skip_64_eetcd.ResponseHeader'(<<_:64, Rest/binary>>,
			       Z1, Z2, F@_1, F@_2, F@_3, F@_4, TrUserData) ->
    'dfp_read_field_def_eetcd.ResponseHeader'(Rest, Z1, Z2,
					      F@_1, F@_2, F@_3, F@_4,
					      TrUserData).

'decode_msg_eetcd.HashRequest'(Bin, TrUserData) ->
    'dfp_read_field_def_eetcd.HashRequest'(Bin, 0, 0,
					   TrUserData).

'dfp_read_field_def_eetcd.HashRequest'(<<>>, 0, 0, _) ->
    #{};
'dfp_read_field_def_eetcd.HashRequest'(Other, Z1, Z2,
				       TrUserData) ->
    'dg_read_field_def_eetcd.HashRequest'(Other, Z1, Z2,
					  TrUserData).

'dg_read_field_def_eetcd.HashRequest'(<<1:1, X:7,
					Rest/binary>>,
				      N, Acc, TrUserData)
    when N < 32 - 7 ->
    'dg_read_field_def_eetcd.HashRequest'(Rest, N + 7,
					  X bsl N + Acc, TrUserData);
'dg_read_field_def_eetcd.HashRequest'(<<0:1, X:7,
					Rest/binary>>,
				      N, Acc, TrUserData) ->
    Key = X bsl N + Acc,
    case Key band 7 of
      0 ->
	  'skip_varint_eetcd.HashRequest'(Rest, 0, 0, TrUserData);
      1 ->
	  'skip_64_eetcd.HashRequest'(Rest, 0, 0, TrUserData);
      2 ->
	  'skip_length_delimited_eetcd.HashRequest'(Rest, 0, 0,
						    TrUserData);
      3 ->
	  'skip_group_eetcd.HashRequest'(Rest, Key bsr 3, 0,
					 TrUserData);
      5 -> 'skip_32_eetcd.HashRequest'(Rest, 0, 0, TrUserData)
    end;
'dg_read_field_def_eetcd.HashRequest'(<<>>, 0, 0, _) ->
    #{}.

'skip_varint_eetcd.HashRequest'(<<1:1, _:7,
				  Rest/binary>>,
				Z1, Z2, TrUserData) ->
    'skip_varint_eetcd.HashRequest'(Rest, Z1, Z2,
				    TrUserData);
'skip_varint_eetcd.HashRequest'(<<0:1, _:7,
				  Rest/binary>>,
				Z1, Z2, TrUserData) ->
    'dfp_read_field_def_eetcd.HashRequest'(Rest, Z1, Z2,
					   TrUserData).

'skip_length_delimited_eetcd.HashRequest'(<<1:1, X:7,
					    Rest/binary>>,
					  N, Acc, TrUserData)
    when N < 57 ->
    'skip_length_delimited_eetcd.HashRequest'(Rest, N + 7,
					      X bsl N + Acc, TrUserData);
'skip_length_delimited_eetcd.HashRequest'(<<0:1, X:7,
					    Rest/binary>>,
					  N, Acc, TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    'dfp_read_field_def_eetcd.HashRequest'(Rest2, 0, 0,
					   TrUserData).

'skip_group_eetcd.HashRequest'(Bin, FNum, Z2,
			       TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    'dfp_read_field_def_eetcd.HashRequest'(Rest, 0, Z2,
					   TrUserData).

'skip_32_eetcd.HashRequest'(<<_:32, Rest/binary>>, Z1,
			    Z2, TrUserData) ->
    'dfp_read_field_def_eetcd.HashRequest'(Rest, Z1, Z2,
					   TrUserData).

'skip_64_eetcd.HashRequest'(<<_:64, Rest/binary>>, Z1,
			    Z2, TrUserData) ->
    'dfp_read_field_def_eetcd.HashRequest'(Rest, Z1, Z2,
					   TrUserData).

'decode_msg_eetcd.HashKVRequest'(Bin, TrUserData) ->
    'dfp_read_field_def_eetcd.HashKVRequest'(Bin, 0, 0,
					     id(0, TrUserData), TrUserData).

'dfp_read_field_def_eetcd.HashKVRequest'(<<8,
					   Rest/binary>>,
					 Z1, Z2, F@_1, TrUserData) ->
    'd_field_eetcd.HashKVRequest_revision'(Rest, Z1, Z2,
					   F@_1, TrUserData);
'dfp_read_field_def_eetcd.HashKVRequest'(<<>>, 0, 0,
					 F@_1, _) ->
    #{revision => F@_1};
'dfp_read_field_def_eetcd.HashKVRequest'(Other, Z1, Z2,
					 F@_1, TrUserData) ->
    'dg_read_field_def_eetcd.HashKVRequest'(Other, Z1, Z2,
					    F@_1, TrUserData).

'dg_read_field_def_eetcd.HashKVRequest'(<<1:1, X:7,
					  Rest/binary>>,
					N, Acc, F@_1, TrUserData)
    when N < 32 - 7 ->
    'dg_read_field_def_eetcd.HashKVRequest'(Rest, N + 7,
					    X bsl N + Acc, F@_1, TrUserData);
'dg_read_field_def_eetcd.HashKVRequest'(<<0:1, X:7,
					  Rest/binary>>,
					N, Acc, F@_1, TrUserData) ->
    Key = X bsl N + Acc,
    case Key of
      8 ->
	  'd_field_eetcd.HashKVRequest_revision'(Rest, 0, 0, F@_1,
						 TrUserData);
      _ ->
	  case Key band 7 of
	    0 ->
		'skip_varint_eetcd.HashKVRequest'(Rest, 0, 0, F@_1,
						  TrUserData);
	    1 ->
		'skip_64_eetcd.HashKVRequest'(Rest, 0, 0, F@_1,
					      TrUserData);
	    2 ->
		'skip_length_delimited_eetcd.HashKVRequest'(Rest, 0, 0,
							    F@_1, TrUserData);
	    3 ->
		'skip_group_eetcd.HashKVRequest'(Rest, Key bsr 3, 0,
						 F@_1, TrUserData);
	    5 ->
		'skip_32_eetcd.HashKVRequest'(Rest, 0, 0, F@_1,
					      TrUserData)
	  end
    end;
'dg_read_field_def_eetcd.HashKVRequest'(<<>>, 0, 0,
					F@_1, _) ->
    #{revision => F@_1}.

'd_field_eetcd.HashKVRequest_revision'(<<1:1, X:7,
					 Rest/binary>>,
				       N, Acc, F@_1, TrUserData)
    when N < 57 ->
    'd_field_eetcd.HashKVRequest_revision'(Rest, N + 7,
					   X bsl N + Acc, F@_1, TrUserData);
'd_field_eetcd.HashKVRequest_revision'(<<0:1, X:7,
					 Rest/binary>>,
				       N, Acc, _, TrUserData) ->
    {NewFValue, RestF} = {begin
			    <<Res:64/signed-native>> = <<(X bsl N +
			  ...
			  Rest},
    'dfp_read_field_def_eetcd.HashKVRequest'(RestF, 0, 0,
					     NewFValue, TrUserData).

'skip_varint_eetcd.HashKVRequest'(<<1:1, _:7,
				    Rest/binary>>,
				  Z1, Z2, F@_1, TrUserData) ->
    'skip_varint_eetcd.HashKVRequest'(Rest, Z1, Z2, F@_1,
				      TrUserData);
'skip_varint_eetcd.HashKVRequest'(<<0:1, _:7,
				    Rest/binary>>,
				  Z1, Z2, F@_1, TrUserData) ->
    'dfp_read_field_def_eetcd.HashKVRequest'(Rest, Z1, Z2,
					     F@_1, TrUserData).

'skip_length_delimited_eetcd.HashKVRequest'(<<1:1, X:7,
					      Rest/binary>>,
					    N, Acc, F@_1, TrUserData)
    when N < 57 ->
    'skip_length_delimited_eetcd.HashKVRequest'(Rest, N + 7,
						X bsl N + Acc, F@_1,
						TrUserData);
'skip_length_delimited_eetcd.HashKVRequest'(<<0:1, X:7,
					      Rest/binary>>,
					    N, Acc, F@_1, TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    'dfp_read_field_def_eetcd.HashKVRequest'(Rest2, 0, 0,
					     F@_1, TrUserData).

'skip_group_eetcd.HashKVRequest'(Bin, FNum, Z2, F@_1,
				 TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    'dfp_read_field_def_eetcd.HashKVRequest'(Rest, 0, Z2,
					     F@_1, TrUserData).

'skip_32_eetcd.HashKVRequest'(<<_:32, Rest/binary>>, Z1,
			      Z2, F@_1, TrUserData) ->
    'dfp_read_field_def_eetcd.HashKVRequest'(Rest, Z1, Z2,
					     F@_1, TrUserData).

'skip_64_eetcd.HashKVRequest'(<<_:64, Rest/binary>>, Z1,
			      Z2, F@_1, TrUserData) ->
    'dfp_read_field_def_eetcd.HashKVRequest'(Rest, Z1, Z2,
					     F@_1, TrUserData).

'decode_msg_eetcd.HashKVResponse'(Bin, TrUserData) ->
    'dfp_read_field_def_eetcd.HashKVResponse'(Bin, 0, 0,
					      id('$undef', TrUserData),
					      id(0, TrUserData),
					      id(0, TrUserData), TrUserData).

'dfp_read_field_def_eetcd.HashKVResponse'(<<10,
					    Rest/binary>>,
					  Z1, Z2, F@_1, F@_2, F@_3,
					  TrUserData) ->
    'd_field_eetcd.HashKVResponse_header'(Rest, Z1, Z2,
					  F@_1, F@_2, F@_3, TrUserData);
'dfp_read_field_def_eetcd.HashKVResponse'(<<16,
					    Rest/binary>>,
					  Z1, Z2, F@_1, F@_2, F@_3,
					  TrUserData) ->
    'd_field_eetcd.HashKVResponse_hash'(Rest, Z1, Z2, F@_1,
					F@_2, F@_3, TrUserData);
'dfp_read_field_def_eetcd.HashKVResponse'(<<24,
					    Rest/binary>>,
					  Z1, Z2, F@_1, F@_2, F@_3,
					  TrUserData) ->
    'd_field_eetcd.HashKVResponse_compact_revision'(Rest,
						    Z1, Z2, F@_1, F@_2, F@_3,
						    TrUserData);
'dfp_read_field_def_eetcd.HashKVResponse'(<<>>, 0, 0,
					  F@_1, F@_2, F@_3, _) ->
    S1 = #{hash => F@_2, compact_revision => F@_3},
    if F@_1 == '$undef' -> S1;
       true -> S1#{header => F@_1}
    end;
'dfp_read_field_def_eetcd.HashKVResponse'(Other, Z1, Z2,
					  F@_1, F@_2, F@_3, TrUserData) ->
    'dg_read_field_def_eetcd.HashKVResponse'(Other, Z1, Z2,
					     F@_1, F@_2, F@_3, TrUserData).

'dg_read_field_def_eetcd.HashKVResponse'(<<1:1, X:7,
					   Rest/binary>>,
					 N, Acc, F@_1, F@_2, F@_3, TrUserData)
    when N < 32 - 7 ->
    'dg_read_field_def_eetcd.HashKVResponse'(Rest, N + 7,
					     X bsl N + Acc, F@_1, F@_2, F@_3,
					     TrUserData);
'dg_read_field_def_eetcd.HashKVResponse'(<<0:1, X:7,
					   Rest/binary>>,
    ...
    case Key of
      10 ->
	  'd_field_eetcd.HashKVResponse_header'(Rest, 0, 0, F@_1,
						F@_2, F@_3, TrUserData);
      16 ->
	  'd_field_eetcd.HashKVResponse_hash'(Rest, 0, 0, F@_1,
					      F@_2, F@_3, TrUserData);
      24 ->
	  'd_field_eetcd.HashKVResponse_compact_revision'(Rest, 0,
							  0, F@_1, F@_2, F@_3,
							  TrUserData);
      _ ->
	  case Key band 7 of
	    0 ->
		'skip_varint_eetcd.HashKVResponse'(Rest, 0, 0, F@_1,
						   F@_2, F@_3, TrUserData);
	    1 ->
		'skip_64_eetcd.HashKVResponse'(Rest, 0, 0, F@_1, F@_2,
					       F@_3, TrUserData);
	    2 ->
		'skip_length_delimited_eetcd.HashKVResponse'(Rest, 0, 0,
							     F@_1, F@_2, F@_3,
							     TrUserData);
	    3 ->
		'skip_group_eetcd.HashKVResponse'(Rest, Key bsr 3, 0,
						  F@_1, F@_2, F@_3, TrUserData);
	    5 ->
		'skip_32_eetcd.HashKVResponse'(Rest, 0, 0, F@_1, F@_2,
					       F@_3, TrUserData)
	  end
    end;
'dg_read_field_def_eetcd.HashKVResponse'(<<>>, 0, 0,
					 F@_1, F@_2, F@_3, _) ->
    S1 = #{hash => F@_2, compact_revision => F@_3},
    if F@_1 == '$undef' -> S1;
       true -> S1#{header => F@_1}
...
'd_field_eetcd.HashKVResponse_header'(<<1:1, X:7,
					Rest/binary>>,
				      N, Acc, F@_1, F@_2, F@_3, TrUserData)
    when N < 57 ->
    'd_field_eetcd.HashKVResponse_header'(Rest, N + 7,
					  X bsl N + Acc, F@_1, F@_2, F@_3,
					  TrUserData);
'd_field_eetcd.HashKVResponse_header'(<<0:1, X:7,
					Rest/binary>>,
				      N, Acc, Prev, F@_2, F@_3, TrUserData) ->
    {NewFValue, RestF} = begin
			   Len = X bsl N + Acc,
			   <<Bs:Len/binary, Rest2/binary>> = Rest,
			   {id('decode_msg_eetcd.ResponseHeader'(Bs,
								 TrUserData),
			       TrUserData),
			    Rest2}
			 end,
    'dfp_read_field_def_eetcd.HashKVResponse'(RestF, 0, 0,
					      if Prev == '$undef' -> NewFValue;
						 true ->
						     'merge_msg_eetcd.ResponseHeader'(Prev,
										      NewFValue,
										      TrUserData)
					      end,
					      F@_2, F@_3, TrUserData).

'd_field_eetcd.HashKVResponse_hash'(<<1:1, X:7,
				      Rest/binary>>,
				    N, Acc, F@_1, F@_2, F@_3, TrUserData)
    when N < 57 ->
    'd_field_eetcd.HashKVResponse_hash'(Rest, N + 7,
					X bsl N + Acc, F@_1, F@_2, F@_3,
					TrUserData);
'd_field_eetcd.HashKVResponse_hash'(<<0:1, X:7,
				      Rest/binary>>,
...
'd_field_eetcd.HashKVResponse_compact_revision'(<<1:1,
						  X:7, Rest/binary>>,
						N, Acc, F@_1, F@_2, F@_3,
						TrUserData)
    when N < 57 ->
    'd_field_eetcd.HashKVResponse_compact_revision'(Rest,
						    N + 7, X bsl N + Acc, F@_1,
						    F@_2, F@_3, TrUserData);
'd_field_eetcd.HashKVResponse_compact_revision'(<<0:1,
						  X:7, Rest/binary>>,
						N, Acc, F@_1, F@_2, _,
						TrUserData) ->
    {NewFValue, RestF} = {begin
...
'skip_varint_eetcd.HashKVResponse'(<<1:1, _:7,
				     Rest/binary>>,
				   Z1, Z2, F@_1, F@_2, F@_3, TrUserData) ->
    'skip_varint_eetcd.HashKVResponse'(Rest, Z1, Z2, F@_1,
				       F@_2, F@_3, TrUserData);
'skip_varint_eetcd.HashKVResponse'(<<0:1, _:7,
				     Rest/binary>>,
				   Z1, Z2, F@_1, F@_2, F@_3, TrUserData) ->
    'dfp_read_field_def_eetcd.HashKVResponse'(Rest, Z1, Z2,
					      F@_1, F@_2, F@_3, TrUserData).

'skip_length_delimited_eetcd.HashKVResponse'(<<1:1, X:7,
					       Rest/binary>>,
					     N, Acc, F@_1, F@_2, F@_3,
					     TrUserData)
    when N < 57 ->
    'skip_length_delimited_eetcd.HashKVResponse'(Rest,
						 N + 7, X bsl N + Acc, F@_1,
						 F@_2, F@_3, TrUserData);
'skip_length_delimited_eetcd.HashKVResponse'(<<0:1, X:7,
					       Rest/binary>>,
					     N, Acc, F@_1, F@_2, F@_3,
					     TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    'dfp_read_field_def_eetcd.HashKVResponse'(Rest2, 0, 0,
					      F@_1, F@_2, F@_3, TrUserData).

'skip_group_eetcd.HashKVResponse'(Bin, FNum, Z2, F@_1,
				  F@_2, F@_3, TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    'dfp_read_field_def_eetcd.HashKVResponse'(Rest, 0, Z2,
					      F@_1, F@_2, F@_3, TrUserData).

'skip_32_eetcd.HashKVResponse'(<<_:32, Rest/binary>>,
			       Z1, Z2, F@_1, F@_2, F@_3, TrUserData) ->
    'dfp_read_field_def_eetcd.HashKVResponse'(Rest, Z1, Z2,
					      F@_1, F@_2, F@_3, TrUserData).

'skip_64_eetcd.HashKVResponse'(<<_:64, Rest/binary>>,
			       Z1, Z2, F@_1, F@_2, F@_3, TrUserData) ->
    'dfp_read_field_def_eetcd.HashKVResponse'(Rest, Z1, Z2,
					      F@_1, F@_2, F@_3, TrUserData).

'decode_msg_eetcd.HashResponse'(Bin, TrUserData) ->
    'dfp_read_field_def_eetcd.HashResponse'(Bin, 0, 0,
					    id('$undef', TrUserData),
					    id(0, TrUserData), TrUserData).

'dfp_read_field_def_eetcd.HashResponse'(<<10,
					  Rest/binary>>,
					Z1, Z2, F@_1, F@_2, TrUserData) ->
    'd_field_eetcd.HashResponse_header'(Rest, Z1, Z2, F@_1,
					F@_2, TrUserData);
'dfp_read_field_def_eetcd.HashResponse'(<<16,
					  Rest/binary>>,
					Z1, Z2, F@_1, F@_2, TrUserData) ->
    'd_field_eetcd.HashResponse_hash'(Rest, Z1, Z2, F@_1,
				      F@_2, TrUserData);
'dfp_read_field_def_eetcd.HashResponse'(<<>>, 0, 0,
					F@_1, F@_2, _) ->
    S1 = #{hash => F@_2},
    if F@_1 == '$undef' -> S1;
       true -> S1#{header => F@_1}
    end;
'dfp_read_field_def_eetcd.HashResponse'(Other, Z1, Z2,
					F@_1, F@_2, TrUserData) ->
    'dg_read_field_def_eetcd.HashResponse'(Other, Z1, Z2,
					   F@_1, F@_2, TrUserData).

'dg_read_field_def_eetcd.HashResponse'(<<1:1, X:7,
					 Rest/binary>>,
				       N, Acc, F@_1, F@_2, TrUserData)
    when N < 32 - 7 ->
    'dg_read_field_def_eetcd.HashResponse'(Rest, N + 7,
					   X bsl N + Acc, F@_1, F@_2,
					   TrUserData);
'dg_read_field_def_eetcd.HashResponse'(<<0:1, X:7,
					 Rest/binary>>,
				       N, Acc, F@_1, F@_2, TrUserData) ->
    Key = X bsl N + Acc,
    case Key of
      10 ->
	  'd_field_eetcd.HashResponse_header'(Rest, 0, 0, F@_1,
					      F@_2, TrUserData);
      16 ->
	  'd_field_eetcd.HashResponse_hash'(Rest, 0, 0, F@_1,
					    F@_2, TrUserData);
      _ ->
	  case Key band 7 of
	    0 ->
		'skip_varint_eetcd.HashResponse'(Rest, 0, 0, F@_1, F@_2,
						 TrUserData);
	    1 ->
		'skip_64_eetcd.HashResponse'(Rest, 0, 0, F@_1, F@_2,
					     TrUserData);
	    2 ->
		'skip_length_delimited_eetcd.HashResponse'(Rest, 0, 0,
							   F@_1, F@_2,
							   TrUserData);
	    3 ->
		'skip_group_eetcd.HashResponse'(Rest, Key bsr 3, 0,
						F@_1, F@_2, TrUserData);
	    5 ->
		'skip_32_eetcd.HashResponse'(Rest, 0, 0, F@_1, F@_2,
					     TrUserData)
	  end
    end;
'dg_read_field_def_eetcd.HashResponse'(<<>>, 0, 0, F@_1,
				       F@_2, _) ->
    S1 = #{hash => F@_2},
    if F@_1 == '$undef' -> S1;
       true -> S1#{header => F@_1}
...
'd_field_eetcd.HashResponse_header'(<<1:1, X:7,
				      Rest/binary>>,
				    N, Acc, F@_1, F@_2, TrUserData)
    when N < 57 ->
    'd_field_eetcd.HashResponse_header'(Rest, N + 7,
					X bsl N + Acc, F@_1, F@_2, TrUserData);
'd_field_eetcd.HashResponse_header'(<<0:1, X:7,
				      Rest/binary>>,
    ...
    'dfp_read_field_def_eetcd.HashResponse'(RestF, 0, 0,
					    if Prev == '$undef' -> NewFValue;
					       true ->
						   'merge_msg_eetcd.ResponseHeader'(Prev,
										    NewFValue,
...
'd_field_eetcd.HashResponse_hash'(<<1:1, X:7,
				    Rest/binary>>,
				  N, Acc, F@_1, F@_2, TrUserData)
    when N < 57 ->
    'd_field_eetcd.HashResponse_hash'(Rest, N + 7,
				      X bsl N + Acc, F@_1, F@_2, TrUserData);
'd_field_eetcd.HashResponse_hash'(<<0:1, X:7,
				    Rest/binary>>,
...
'skip_varint_eetcd.HashResponse'(<<1:1, _:7,
				   Rest/binary>>,
				 Z1, Z2, F@_1, F@_2, TrUserData) ->
    'skip_varint_eetcd.HashResponse'(Rest, Z1, Z2, F@_1,
				     F@_2, TrUserData);
'skip_varint_eetcd.HashResponse'(<<0:1, _:7,
				   Rest/binary>>,
				 Z1, Z2, F@_1, F@_2, TrUserData) ->
    'dfp_read_field_def_eetcd.HashResponse'(Rest, Z1, Z2,
					    F@_1, F@_2, TrUserData).

'skip_length_delimited_eetcd.HashResponse'(<<1:1, X:7,
					     Rest/binary>>,
					   N, Acc, F@_1, F@_2, TrUserData)
    when N < 57 ->
    'skip_length_delimited_eetcd.HashResponse'(Rest, N + 7,
					       X bsl N + Acc, F@_1, F@_2,
					       TrUserData);
'skip_length_delimited_eetcd.HashResponse'(<<0:1, X:7,
					     Rest/binary>>,
					   N, Acc, F@_1, F@_2, TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    'dfp_read_field_def_eetcd.HashResponse'(Rest2, 0, 0,
					    F@_1, F@_2, TrUserData).

'skip_group_eetcd.HashResponse'(Bin, FNum, Z2, F@_1,
				F@_2, TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    'dfp_read_field_def_eetcd.HashResponse'(Rest, 0, Z2,
					    F@_1, F@_2, TrUserData).

'skip_32_eetcd.HashResponse'(<<_:32, Rest/binary>>, Z1,
			     Z2, F@_1, F@_2, TrUserData) ->
    'dfp_read_field_def_eetcd.HashResponse'(Rest, Z1, Z2,
					    F@_1, F@_2, TrUserData).

'skip_64_eetcd.HashResponse'(<<_:64, Rest/binary>>, Z1,
			     Z2, F@_1, F@_2, TrUserData) ->
    'dfp_read_field_def_eetcd.HashResponse'(Rest, Z1, Z2,
					    F@_1, F@_2, TrUserData).

'decode_msg_eetcd.KeyValue'(Bin, TrUserData) ->
    'dfp_read_field_def_eetcd.KeyValue'(Bin, 0, 0,
					id(<<>>, TrUserData), id(0, TrUserData),
					id(0, TrUserData), id(0, TrUserData),
					id(<<>>, TrUserData), id(0, TrUserData),
					TrUserData).

'dfp_read_field_def_eetcd.KeyValue'(<<10, Rest/binary>>,
				    Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6,
				    TrUserData) ->
    'd_field_eetcd.KeyValue_key'(Rest, Z1, Z2, F@_1, F@_2,
				 F@_3, F@_4, F@_5, F@_6, TrUserData);
'dfp_read_field_def_eetcd.KeyValue'(<<16, Rest/binary>>,
				    Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6,
				    TrUserData) ->
    'd_field_eetcd.KeyValue_create_revision'(Rest, Z1, Z2,
					     F@_1, F@_2, F@_3, F@_4, F@_5, F@_6,
					     TrUserData);
'dfp_read_field_def_eetcd.KeyValue'(<<24, Rest/binary>>,
				    Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6,
				    TrUserData) ->
    'd_field_eetcd.KeyValue_mod_revision'(Rest, Z1, Z2,
					  F@_1, F@_2, F@_3, F@_4, F@_5, F@_6,
					  TrUserData);
'dfp_read_field_def_eetcd.KeyValue'(<<32, Rest/binary>>,
				    Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6,
				    TrUserData) ->
    'd_field_eetcd.KeyValue_version'(Rest, Z1, Z2, F@_1,
				     F@_2, F@_3, F@_4, F@_5, F@_6, TrUserData);
'dfp_read_field_def_eetcd.KeyValue'(<<42, Rest/binary>>,
				    Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6,
				    TrUserData) ->
    'd_field_eetcd.KeyValue_value'(Rest, Z1, Z2, F@_1, F@_2,
				   F@_3, F@_4, F@_5, F@_6, TrUserData);
'dfp_read_field_def_eetcd.KeyValue'(<<48, Rest/binary>>,
				    Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6,
				    TrUserData) ->
    'd_field_eetcd.KeyValue_lease'(Rest, Z1, Z2, F@_1, F@_2,
				   F@_3, F@_4, F@_5, F@_6, TrUserData);
'dfp_read_field_def_eetcd.KeyValue'(<<>>, 0, 0, F@_1,
				    F@_2, F@_3, F@_4, F@_5, F@_6, _) ->
    #{key => F@_1, create_revision => F@_2,
      mod_revision => F@_3, version => F@_4, value => F@_5,
      lease => F@_6};
'dfp_read_field_def_eetcd.KeyValue'(Other, Z1, Z2, F@_1,
				    F@_2, F@_3, F@_4, F@_5, F@_6, TrUserData) ->
    'dg_read_field_def_eetcd.KeyValue'(Other, Z1, Z2, F@_1,
				       F@_2, F@_3, F@_4, F@_5, F@_6,
				       TrUserData).

'dg_read_field_def_eetcd.KeyValue'(<<1:1, X:7,
				     Rest/binary>>,
				   N, Acc, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6,
				   TrUserData)
    when N < 32 - 7 ->
    'dg_read_field_def_eetcd.KeyValue'(Rest, N + 7,
				       X bsl N + Acc, F@_1, F@_2, F@_3, F@_4,
				       F@_5, F@_6, TrUserData);
'dg_read_field_def_eetcd.KeyValue'(<<0:1, X:7,
				     Rest/binary>>,
				   N, Acc, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6,
				   TrUserData) ->
    Key = X bsl N + Acc,
    case Key of
      10 ->
	  'd_field_eetcd.KeyValue_key'(Rest, 0, 0, F@_1, F@_2,
				       F@_3, F@_4, F@_5, F@_6, TrUserData);
      16 ->
	  'd_field_eetcd.KeyValue_create_revision'(Rest, 0, 0,
						   F@_1, F@_2, F@_3, F@_4, F@_5,
						   F@_6, TrUserData);
      24 ->
	  'd_field_eetcd.KeyValue_mod_revision'(Rest, 0, 0, F@_1,
						F@_2, F@_3, F@_4, F@_5, F@_6,
						TrUserData);
      32 ->
	  'd_field_eetcd.KeyValue_version'(Rest, 0, 0, F@_1, F@_2,
					   F@_3, F@_4, F@_5, F@_6, TrUserData);
      42 ->
	  'd_field_eetcd.KeyValue_value'(Rest, 0, 0, F@_1, F@_2,
					 F@_3, F@_4, F@_5, F@_6, TrUserData);
      48 ->
	  'd_field_eetcd.KeyValue_lease'(Rest, 0, 0, F@_1, F@_2,
					 F@_3, F@_4, F@_5, F@_6, TrUserData);
      _ ->
	  case Key band 7 of
	    0 ->
		'skip_varint_eetcd.KeyValue'(Rest, 0, 0, F@_1, F@_2,
					     F@_3, F@_4, F@_5, F@_6,
					     TrUserData);
	    1 ->
		'skip_64_eetcd.KeyValue'(Rest, 0, 0, F@_1, F@_2, F@_3,
					 F@_4, F@_5, F@_6, TrUserData);
	    2 ->
		'skip_length_delimited_eetcd.KeyValue'(Rest, 0, 0, F@_1,
						       F@_2, F@_3, F@_4, F@_5,
						       F@_6, TrUserData);
	    3 ->
		'skip_group_eetcd.KeyValue'(Rest, Key bsr 3, 0, F@_1,
					    F@_2, F@_3, F@_4, F@_5, F@_6,
					    TrUserData);
	    5 ->
		'skip_32_eetcd.KeyValue'(Rest, 0, 0, F@_1, F@_2, F@_3,
					 F@_4, F@_5, F@_6, TrUserData)
	  end
    end;
'dg_read_field_def_eetcd.KeyValue'(<<>>, 0, 0, F@_1,
				   F@_2, F@_3, F@_4, F@_5, F@_6, _) ->
    #{key => F@_1, create_revision => F@_2,
      mod_revision => F@_3, version => F@_4, value => F@_5,
      lease => F@_6}.

'd_field_eetcd.KeyValue_key'(<<1:1, X:7, Rest/binary>>,
			     N, Acc, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6,
			     TrUserData)
    when N < 57 ->
    'd_field_eetcd.KeyValue_key'(Rest, N + 7, X bsl N + Acc,
				 F@_1, F@_2, F@_3, F@_4, F@_5, F@_6,
				 TrUserData);
'd_field_eetcd.KeyValue_key'(<<0:1, X:7, Rest/binary>>,
    ...
    'dfp_read_field_def_eetcd.KeyValue'(RestF, 0, 0,
					NewFValue, F@_2, F@_3, F@_4, F@_5, F@_6,
					TrUserData).

'd_field_eetcd.KeyValue_create_revision'(<<1:1, X:7,
					   Rest/binary>>,
					 N, Acc, F@_1, F@_2, F@_3, F@_4, F@_5,
					 F@_6, TrUserData)
    when N < 57 ->
    'd_field_eetcd.KeyValue_create_revision'(Rest, N + 7,
					     X bsl N + Acc, F@_1, F@_2, F@_3,
					     F@_4, F@_5, F@_6, TrUserData);
'd_field_eetcd.KeyValue_create_revision'(<<0:1, X:7,
					   Rest/binary>>,
    ...
    {NewFValue, RestF} = {begin
			  ...
			  Rest},
    'dfp_read_field_def_eetcd.KeyValue'(RestF, 0, 0, F@_1,
					NewFValue, F@_3, F@_4, F@_5, F@_6,
					TrUserData).

'd_field_eetcd.KeyValue_mod_revision'(<<1:1, X:7,
					Rest/binary>>,
				      N, Acc, F@_1, F@_2, F@_3, F@_4, F@_5,
				      F@_6, TrUserData)
    when N < 57 ->
    'd_field_eetcd.KeyValue_mod_revision'(Rest, N + 7,
					  X bsl N + Acc, F@_1, F@_2, F@_3, F@_4,
					  F@_5, F@_6, TrUserData);
'd_field_eetcd.KeyValue_mod_revision'(<<0:1, X:7,
					Rest/binary>>,
...
'd_field_eetcd.KeyValue_version'(<<1:1, X:7,
				   Rest/binary>>,
				 N, Acc, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6,
				 TrUserData)
    when N < 57 ->
    'd_field_eetcd.KeyValue_version'(Rest, N + 7,
				     X bsl N + Acc, F@_1, F@_2, F@_3, F@_4,
				     F@_5, F@_6, TrUserData);
'd_field_eetcd.KeyValue_version'(<<0:1, X:7,
				   Rest/binary>>,
...
'd_field_eetcd.KeyValue_value'(<<1:1, X:7,
				 Rest/binary>>,
			       N, Acc, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6,
			       TrUserData)
    when N < 57 ->
    'd_field_eetcd.KeyValue_value'(Rest, N + 7,
				   X bsl N + Acc, F@_1, F@_2, F@_3, F@_4, F@_5,
				   F@_6, TrUserData);
'd_field_eetcd.KeyValue_value'(<<0:1, X:7,
				 Rest/binary>>,
...
'd_field_eetcd.KeyValue_lease'(<<1:1, X:7,
				 Rest/binary>>,
			       N, Acc, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6,
			       TrUserData)
    when N < 57 ->
    'd_field_eetcd.KeyValue_lease'(Rest, N + 7,
				   X bsl N + Acc, F@_1, F@_2, F@_3, F@_4, F@_5,
				   F@_6, TrUserData);
'd_field_eetcd.KeyValue_lease'(<<0:1, X:7,
				 Rest/binary>>,
...
'skip_varint_eetcd.KeyValue'(<<1:1, _:7, Rest/binary>>,
			     Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6,
			     TrUserData) ->
    'skip_varint_eetcd.KeyValue'(Rest, Z1, Z2, F@_1, F@_2,
				 F@_3, F@_4, F@_5, F@_6, TrUserData);
'skip_varint_eetcd.KeyValue'(<<0:1, _:7, Rest/binary>>,
			     Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5, F@_6,
			     TrUserData) ->
    'dfp_read_field_def_eetcd.KeyValue'(Rest, Z1, Z2, F@_1,
					F@_2, F@_3, F@_4, F@_5, F@_6,
					TrUserData).

'skip_length_delimited_eetcd.KeyValue'(<<1:1, X:7,
					 Rest/binary>>,
				       N, Acc, F@_1, F@_2, F@_3, F@_4, F@_5,
				       F@_6, TrUserData)
    when N < 57 ->
    'skip_length_delimited_eetcd.KeyValue'(Rest, N + 7,
					   X bsl N + Acc, F@_1, F@_2, F@_3,
					   F@_4, F@_5, F@_6, TrUserData);
'skip_length_delimited_eetcd.KeyValue'(<<0:1, X:7,
					 Rest/binary>>,
				       N, Acc, F@_1, F@_2, F@_3, F@_4, F@_5,
				       F@_6, TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    'dfp_read_field_def_eetcd.KeyValue'(Rest2, 0, 0, F@_1,
					F@_2, F@_3, F@_4, F@_5, F@_6,
					TrUserData).

'skip_group_eetcd.KeyValue'(Bin, FNum, Z2, F@_1, F@_2,
			    F@_3, F@_4, F@_5, F@_6, TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    'dfp_read_field_def_eetcd.KeyValue'(Rest, 0, Z2, F@_1,
					F@_2, F@_3, F@_4, F@_5, F@_6,
					TrUserData).

'skip_32_eetcd.KeyValue'(<<_:32, Rest/binary>>, Z1, Z2,
			 F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, TrUserData) ->
    'dfp_read_field_def_eetcd.KeyValue'(Rest, Z1, Z2, F@_1,
					F@_2, F@_3, F@_4, F@_5, F@_6,
					TrUserData).

'skip_64_eetcd.KeyValue'(<<_:64, Rest/binary>>, Z1, Z2,
			 F@_1, F@_2, F@_3, F@_4, F@_5, F@_6, TrUserData) ->
    'dfp_read_field_def_eetcd.KeyValue'(Rest, Z1, Z2, F@_1,
					F@_2, F@_3, F@_4, F@_5, F@_6,
					TrUserData).

'decode_msg_eetcd.Event'(Bin, TrUserData) ->
    'dfp_read_field_def_eetcd.Event'(Bin, 0, 0,
				     id('PUT', TrUserData),
				     id('$undef', TrUserData),
				     id('$undef', TrUserData), TrUserData).

'dfp_read_field_def_eetcd.Event'(<<8, Rest/binary>>, Z1,
				 Z2, F@_1, F@_2, F@_3, TrUserData) ->
    'd_field_eetcd.Event_type'(Rest, Z1, Z2, F@_1, F@_2,
			       F@_3, TrUserData);
'dfp_read_field_def_eetcd.Event'(<<18, Rest/binary>>,
				 Z1, Z2, F@_1, F@_2, F@_3, TrUserData) ->
    'd_field_eetcd.Event_kv'(Rest, Z1, Z2, F@_1, F@_2, F@_3,
			     TrUserData);
'dfp_read_field_def_eetcd.Event'(<<26, Rest/binary>>,
				 Z1, Z2, F@_1, F@_2, F@_3, TrUserData) ->
    'd_field_eetcd.Event_prev_kv'(Rest, Z1, Z2, F@_1, F@_2,
				  F@_3, TrUserData);
'dfp_read_field_def_eetcd.Event'(<<>>, 0, 0, F@_1, F@_2,
				 F@_3, _) ->
    S1 = #{type => F@_1},
    S2 = if F@_2 == '$undef' -> S1;
	    true -> S1#{kv => F@_2}
...
'dfp_read_field_def_eetcd.Event'(Other, Z1, Z2, F@_1,
				 F@_2, F@_3, TrUserData) ->
    'dg_read_field_def_eetcd.Event'(Other, Z1, Z2, F@_1,
				    F@_2, F@_3, TrUserData).

'dg_read_field_def_eetcd.Event'(<<1:1, X:7,
				  Rest/binary>>,
				N, Acc, F@_1, F@_2, F@_3, TrUserData)
    when N < 32 - 7 ->
    'dg_read_field_def_eetcd.Event'(Rest, N + 7,
				    X bsl N + Acc, F@_1, F@_2, F@_3,
				    TrUserData);
'dg_read_field_def_eetcd.Event'(<<0:1, X:7,
				  Rest/binary>>,
				N, Acc, F@_1, F@_2, F@_3, TrUserData) ->
    Key = X bsl N + Acc,
    case Key of
      8 ->
	  'd_field_eetcd.Event_type'(Rest, 0, 0, F@_1, F@_2, F@_3,
				     TrUserData);
      18 ->
	  'd_field_eetcd.Event_kv'(Rest, 0, 0, F@_1, F@_2, F@_3,
				   TrUserData);
      26 ->
	  'd_field_eetcd.Event_prev_kv'(Rest, 0, 0, F@_1, F@_2,
					F@_3, TrUserData);
      _ ->
	  case Key band 7 of
	    0 ->
		'skip_varint_eetcd.Event'(Rest, 0, 0, F@_1, F@_2, F@_3,
					  TrUserData);
	    1 ->
		'skip_64_eetcd.Event'(Rest, 0, 0, F@_1, F@_2, F@_3,
				      TrUserData);
	    2 ->
		'skip_length_delimited_eetcd.Event'(Rest, 0, 0, F@_1,
						    F@_2, F@_3, TrUserData);
	    3 ->
		'skip_group_eetcd.Event'(Rest, Key bsr 3, 0, F@_1, F@_2,
					 F@_3, TrUserData);
	    5 ->
		'skip_32_eetcd.Event'(Rest, 0, 0, F@_1, F@_2, F@_3,
				      TrUserData)
	  end
    end;
'dg_read_field_def_eetcd.Event'(<<>>, 0, 0, F@_1, F@_2,
				F@_3, _) ->
    S1 = #{type => F@_1},
    S2 = if F@_2 == '$undef' -> S1;
	    true -> S1#{kv => F@_2}
...
'd_field_eetcd.Event_type'(<<1:1, X:7, Rest/binary>>, N,
			   Acc, F@_1, F@_2, F@_3, TrUserData)
    when N < 57 ->
    'd_field_eetcd.Event_type'(Rest, N + 7, X bsl N + Acc,
			       F@_1, F@_2, F@_3, TrUserData);
'd_field_eetcd.Event_type'(<<0:1, X:7, Rest/binary>>, N,
			   Acc, _, F@_2, F@_3, TrUserData) ->
    {NewFValue, RestF} =
	{id('d_enum_eetcd.Event.EventType'(begin
	    ...
	    TrUserData),
	 Rest},
    'dfp_read_field_def_eetcd.Event'(RestF, 0, 0, NewFValue,
				     F@_2, F@_3, TrUserData).

'd_field_eetcd.Event_kv'(<<1:1, X:7, Rest/binary>>, N,
			 Acc, F@_1, F@_2, F@_3, TrUserData)
    when N < 57 ->
    'd_field_eetcd.Event_kv'(Rest, N + 7, X bsl N + Acc,
			     F@_1, F@_2, F@_3, TrUserData);
'd_field_eetcd.Event_kv'(<<0:1, X:7, Rest/binary>>, N,
			 Acc, F@_1, Prev, F@_3, TrUserData) ->
    {NewFValue, RestF} = begin
			   Len = X bsl N + Acc,
			   <<Bs:Len/binary, Rest2/binary>> = Rest,
			   {id('decode_msg_eetcd.KeyValue'(Bs, TrUserData),
			       TrUserData),
			    Rest2}
			 end,
    'dfp_read_field_def_eetcd.Event'(RestF, 0, 0, F@_1,
				     if Prev == '$undef' -> NewFValue;
					true ->
					    'merge_msg_eetcd.KeyValue'(Prev,
								       NewFValue,
								       TrUserData)
				     end,
				     F@_3, TrUserData).

'd_field_eetcd.Event_prev_kv'(<<1:1, X:7, Rest/binary>>,
			      N, Acc, F@_1, F@_2, F@_3, TrUserData)
    when N < 57 ->
    'd_field_eetcd.Event_prev_kv'(Rest, N + 7,
				  X bsl N + Acc, F@_1, F@_2, F@_3, TrUserData);
'd_field_eetcd.Event_prev_kv'(<<0:1, X:7, Rest/binary>>,
...
'skip_varint_eetcd.Event'(<<1:1, _:7, Rest/binary>>, Z1,
			  Z2, F@_1, F@_2, F@_3, TrUserData) ->
    'skip_varint_eetcd.Event'(Rest, Z1, Z2, F@_1, F@_2,
			      F@_3, TrUserData);
'skip_varint_eetcd.Event'(<<0:1, _:7, Rest/binary>>, Z1,
			  Z2, F@_1, F@_2, F@_3, TrUserData) ->
    'dfp_read_field_def_eetcd.Event'(Rest, Z1, Z2, F@_1,
				     F@_2, F@_3, TrUserData).

'skip_length_delimited_eetcd.Event'(<<1:1, X:7,
				      Rest/binary>>,
				    N, Acc, F@_1, F@_2, F@_3, TrUserData)
    when N < 57 ->
    'skip_length_delimited_eetcd.Event'(Rest, N + 7,
					X bsl N + Acc, F@_1, F@_2, F@_3,
					TrUserData);
'skip_length_delimited_eetcd.Event'(<<0:1, X:7,
				      Rest/binary>>,
				    N, Acc, F@_1, F@_2, F@_3, TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    'dfp_read_field_def_eetcd.Event'(Rest2, 0, 0, F@_1,
				     F@_2, F@_3, TrUserData).

'skip_group_eetcd.Event'(Bin, FNum, Z2, F@_1, F@_2,
			 F@_3, TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    'dfp_read_field_def_eetcd.Event'(Rest, 0, Z2, F@_1,
				     F@_2, F@_3, TrUserData).

'skip_32_eetcd.Event'(<<_:32, Rest/binary>>, Z1, Z2,
		      F@_1, F@_2, F@_3, TrUserData) ->
    'dfp_read_field_def_eetcd.Event'(Rest, Z1, Z2, F@_1,
				     F@_2, F@_3, TrUserData).

'skip_64_eetcd.Event'(<<_:64, Rest/binary>>, Z1, Z2,
		      F@_1, F@_2, F@_3, TrUserData) ->
    'dfp_read_field_def_eetcd.Event'(Rest, Z1, Z2, F@_1,
				     F@_2, F@_3, TrUserData).
...
'd_enum_eetcd.Event.EventType'(0) -> 'PUT';
'd_enum_eetcd.Event.EventType'(1) -> 'DELETE';
'd_enum_eetcd.Event.EventType'(V) -> V.
...
merge_msgs(Prev, New, MsgName, Opts) ->
    ...
    case MsgName of
      'eetcd.ResponseHeader' ->
	  'merge_msg_eetcd.ResponseHeader'(Prev, New, TrUserData);
      'eetcd.HashRequest' ->
	  'merge_msg_eetcd.HashRequest'(Prev, New, TrUserData);
      'eetcd.HashKVRequest' ->
	  'merge_msg_eetcd.HashKVRequest'(Prev, New, TrUserData);
      'eetcd.HashKVResponse' ->
	  'merge_msg_eetcd.HashKVResponse'(Prev, New, TrUserData);
      'eetcd.HashResponse' ->
	  'merge_msg_eetcd.HashResponse'(Prev, New, TrUserData);
      'eetcd.KeyValue' ->
	  'merge_msg_eetcd.KeyValue'(Prev, New, TrUserData);
      'eetcd.Event' ->
	  'merge_msg_eetcd.Event'(Prev, New, TrUserData);
      'google.protobuf.FileDescriptorSet' ->
...
-compile({nowarn_unused_function,'merge_msg_eetcd.ResponseHeader'/3}).
'merge_msg_eetcd.ResponseHeader'(PMsg, NMsg, _) ->
    S1 = #{},
...
-compile({nowarn_unused_function,'merge_msg_eetcd.HashRequest'/3}).
'merge_msg_eetcd.HashRequest'(_Prev, New,
			      _TrUserData) ->
    New.

-compile({nowarn_unused_function,'merge_msg_eetcd.HashKVRequest'/3}).
'merge_msg_eetcd.HashKVRequest'(PMsg, NMsg, _) ->
    S1 = #{},
    case {PMsg, NMsg} of
      {_, #{revision := NFrevision}} ->
...
-compile({nowarn_unused_function,'merge_msg_eetcd.HashKVResponse'/3}).
'merge_msg_eetcd.HashKVResponse'(PMsg, NMsg,
				 TrUserData) ->
    S1 = #{},
    S2 = case {PMsg, NMsg} of
	   {#{header := PFheader}, #{header := NFheader}} ->
	       S1#{header =>
		       'merge_msg_eetcd.ResponseHeader'(PFheader, NFheader,
							TrUserData)};
...
-compile({nowarn_unused_function,'merge_msg_eetcd.HashResponse'/3}).
'merge_msg_eetcd.HashResponse'(PMsg, NMsg,
			       TrUserData) ->
    S1 = #{},
    S2 = case {PMsg, NMsg} of
	   {#{header := PFheader}, #{header := NFheader}} ->
...
-compile({nowarn_unused_function,'merge_msg_eetcd.KeyValue'/3}).
'merge_msg_eetcd.KeyValue'(PMsg, NMsg, _) ->
    S1 = #{},
    S2 = case {PMsg, NMsg} of
...
-compile({nowarn_unused_function,'merge_msg_eetcd.Event'/3}).
'merge_msg_eetcd.Event'(PMsg, NMsg, TrUserData) ->
    S1 = #{},
    S2 = case {PMsg, NMsg} of
    ...
    S3 = case {PMsg, NMsg} of
	   {#{kv := PFkv}, #{kv := NFkv}} ->
	       S2#{kv =>
		       'merge_msg_eetcd.KeyValue'(PFkv, NFkv, TrUserData)};
    ...
    case {PMsg, NMsg} of
	  ...
	  S3#{prev_kv =>
		  'merge_msg_eetcd.KeyValue'(PFprev_kv, NFprev_kv,
					     TrUserData)};
      {_, #{prev_kv := NFprev_kv}} ->
...
verify_msg(Msg, MsgName, Opts) ->
    ...
    case MsgName of
      'eetcd.ResponseHeader' ->
	  'v_msg_eetcd.ResponseHeader'(Msg, [MsgName],
				       TrUserData);
      'eetcd.HashRequest' ->
	  'v_msg_eetcd.HashRequest'(Msg, [MsgName], TrUserData);
      'eetcd.HashKVRequest' ->
	  'v_msg_eetcd.HashKVRequest'(Msg, [MsgName], TrUserData);
      'eetcd.HashKVResponse' ->
	  'v_msg_eetcd.HashKVResponse'(Msg, [MsgName],
				       TrUserData);
      'eetcd.HashResponse' ->
	  'v_msg_eetcd.HashResponse'(Msg, [MsgName], TrUserData);
      'eetcd.KeyValue' ->
	  'v_msg_eetcd.KeyValue'(Msg, [MsgName], TrUserData);
      'eetcd.Event' ->
	  'v_msg_eetcd.Event'(Msg, [MsgName], TrUserData);
      'google.protobuf.FileDescriptorSet' ->
...
-compile({nowarn_unused_function,'v_msg_eetcd.ResponseHeader'/3}).
-dialyzer({nowarn_function,'v_msg_eetcd.ResponseHeader'/3}).
'v_msg_eetcd.ResponseHeader'(#{} = M, Path,
			     TrUserData) ->
    case M of
      #{cluster_id := F1} ->
    ...
    lists:foreach(fun (cluster_id) -> ok;
		  ...
		  maps:keys(M)),
    ok;
'v_msg_eetcd.ResponseHeader'(M, Path, _TrUserData)
    when is_map(M) ->
    mk_type_error({missing_fields, [] -- maps:keys(M),
		   'eetcd.ResponseHeader'},
		  M, Path);
'v_msg_eetcd.ResponseHeader'(X, Path, _TrUserData) ->
    mk_type_error({expected_msg, 'eetcd.ResponseHeader'}, X,
		  Path).

-compile({nowarn_unused_function,'v_msg_eetcd.HashRequest'/3}).
-dialyzer({nowarn_function,'v_msg_eetcd.HashRequest'/3}).
'v_msg_eetcd.HashRequest'(#{} = M, Path, _) ->
    lists:foreach(fun (OtherKey) ->
			  mk_type_error({extraneous_key, OtherKey}, M, Path)
		  end,
		  maps:keys(M)),
    ok;
'v_msg_eetcd.HashRequest'(M, Path, _TrUserData)
    when is_map(M) ->
    mk_type_error({missing_fields, [] -- maps:keys(M),
		   'eetcd.HashRequest'},
		  M, Path);
'v_msg_eetcd.HashRequest'(X, Path, _TrUserData) ->
    mk_type_error({expected_msg, 'eetcd.HashRequest'}, X,
		  Path).

-compile({nowarn_unused_function,'v_msg_eetcd.HashKVRequest'/3}).
-dialyzer({nowarn_function,'v_msg_eetcd.HashKVRequest'/3}).
'v_msg_eetcd.HashKVRequest'(#{} = M, Path,
			    TrUserData) ->
    case M of
      #{revision := F1} ->
    ...
    lists:foreach(fun (revision) -> ok;
		  ...
		  maps:keys(M)),
    ok;
'v_msg_eetcd.HashKVRequest'(M, Path, _TrUserData)
    when is_map(M) ->
    mk_type_error({missing_fields, [] -- maps:keys(M),
		   'eetcd.HashKVRequest'},
		  M, Path);
'v_msg_eetcd.HashKVRequest'(X, Path, _TrUserData) ->
    mk_type_error({expected_msg, 'eetcd.HashKVRequest'}, X,
		  Path).

-compile({nowarn_unused_function,'v_msg_eetcd.HashKVResponse'/3}).
-dialyzer({nowarn_function,'v_msg_eetcd.HashKVResponse'/3}).
'v_msg_eetcd.HashKVResponse'(#{} = M, Path,
			     TrUserData) ->
    case M of
      #{header := F1} ->
	  'v_msg_eetcd.ResponseHeader'(F1, [header | Path],
				       TrUserData);
      _ -> ok
    end,
    case M of
    ...
    lists:foreach(fun (header) -> ok;
		  ...
		  maps:keys(M)),
    ok;
'v_msg_eetcd.HashKVResponse'(M, Path, _TrUserData)
    when is_map(M) ->
    mk_type_error({missing_fields, [] -- maps:keys(M),
		   'eetcd.HashKVResponse'},
		  M, Path);
'v_msg_eetcd.HashKVResponse'(X, Path, _TrUserData) ->
    mk_type_error({expected_msg, 'eetcd.HashKVResponse'}, X,
		  Path).

-compile({nowarn_unused_function,'v_msg_eetcd.HashResponse'/3}).
-dialyzer({nowarn_function,'v_msg_eetcd.HashResponse'/3}).
'v_msg_eetcd.HashResponse'(#{} = M, Path, TrUserData) ->
    case M of
      #{header := F1} ->
	  'v_msg_eetcd.ResponseHeader'(F1, [header | Path],
				       TrUserData);
    ...
    lists:foreach(fun (header) -> ok;
		  ...
		  maps:keys(M)),
    ok;
'v_msg_eetcd.HashResponse'(M, Path, _TrUserData)
    when is_map(M) ->
    mk_type_error({missing_fields, [] -- maps:keys(M),
		   'eetcd.HashResponse'},
		  M, Path);
'v_msg_eetcd.HashResponse'(X, Path, _TrUserData) ->
    mk_type_error({expected_msg, 'eetcd.HashResponse'}, X,
		  Path).

-compile({nowarn_unused_function,'v_msg_eetcd.KeyValue'/3}).
-dialyzer({nowarn_function,'v_msg_eetcd.KeyValue'/3}).
'v_msg_eetcd.KeyValue'(#{} = M, Path, TrUserData) ->
    case M of
      #{key := F1} ->
    ...
    lists:foreach(fun (key) -> ok;
		  ...
		  maps:keys(M)),
    ok;
'v_msg_eetcd.KeyValue'(M, Path, _TrUserData)
    when is_map(M) ->
    mk_type_error({missing_fields, [] -- maps:keys(M),
		   'eetcd.KeyValue'},
		  M, Path);
'v_msg_eetcd.KeyValue'(X, Path, _TrUserData) ->
    mk_type_error({expected_msg, 'eetcd.KeyValue'}, X,
		  Path).

-compile({nowarn_unused_function,'v_msg_eetcd.Event'/3}).
-dialyzer({nowarn_function,'v_msg_eetcd.Event'/3}).
'v_msg_eetcd.Event'(#{} = M, Path, TrUserData) ->
    case M of
      #{type := F1} ->
	  'v_enum_eetcd.Event.EventType'(F1, [type | Path],
					 TrUserData);
      _ -> ok
    end,
    case M of
      #{kv := F2} ->
	  'v_msg_eetcd.KeyValue'(F2, [kv | Path], TrUserData);
      _ -> ok
    end,
    case M of
      #{prev_kv := F3} ->
	  'v_msg_eetcd.KeyValue'(F3, [prev_kv | Path],
				 TrUserData);
      _ -> ok
    end,
    lists:foreach(fun (type) -> ok;
		  ...
		  maps:keys(M)),
    ok;
'v_msg_eetcd.Event'(M, Path, _TrUserData)
    when is_map(M) ->
    mk_type_error({missing_fields, [] -- maps:keys(M),
		   'eetcd.Event'},
		  M, Path);
'v_msg_eetcd.Event'(X, Path, _TrUserData) ->
    mk_type_error({expected_msg, 'eetcd.Event'}, X, Path).
...
-compile({nowarn_unused_function,'v_enum_eetcd.Event.EventType'/3}).
-dialyzer({nowarn_function,'v_enum_eetcd.Event.EventType'/3}).
'v_enum_eetcd.Event.EventType'('PUT', _Path,
			       _TrUserData) ->
    ok;
'v_enum_eetcd.Event.EventType'('DELETE', _Path,
			       _TrUserData) ->
    ok;
'v_enum_eetcd.Event.EventType'(V, Path, TrUserData)
    when is_integer(V) ->
    v_type_sint32(V, Path, TrUserData);
'v_enum_eetcd.Event.EventType'(X, Path, _TrUserData) ->
    mk_type_error({invalid_enum, 'eetcd.Event.EventType'},
		  X, Path).
...
get_msg_defs() ->
    [{{enum, 'eetcd.Event.EventType'},
	 ...
	 type => {enum, 'eetcd.Event.EventType'},
	 occurrence => optional, opts => []},
       #{name => kv, fnum => 2, rnum => 3,
	 type => {msg, 'eetcd.KeyValue'}, occurrence => optional,
	 opts => []},
...
get_msg_names() ->
    ['eetcd.ResponseHeader', 'eetcd.HashRequest',
     'eetcd.HashKVRequest', 'eetcd.HashKVResponse',
     'eetcd.HashResponse', 'eetcd.KeyValue', 'eetcd.Event',
     'google.protobuf.FileDescriptorSet',
     'google.protobuf.FileDescriptorProto',
     'google.protobuf.DescriptorProto.ExtensionRange',
     'google.protobuf.DescriptorProto.ReservedRange',
...
find_msg_def('eetcd.ResponseHeader') ->
    [#{name => cluster_id, fnum => 1, rnum => 2,
       type => uint64, occurrence => optional, opts => []},
     #{name => member_id, fnum => 2, rnum => 3,
       type => uint64, occurrence => optional, opts => []},
     ...
     #{name => raft_term, fnum => 4, rnum => 5,
       type => uint64, occurrence => optional, opts => []}];
find_msg_def('eetcd.HashRequest') -> [];
find_msg_def('eetcd.HashKVRequest') ->
    [#{name => revision, fnum => 1, rnum => 2,
       type => int64, occurrence => optional, opts => []}];
find_msg_def('eetcd.HashKVResponse') ->
    [#{name => header, fnum => 1, rnum => 2,
       type => {msg, 'eetcd.ResponseHeader'},
       occurrence => optional, opts => []},
     #{name => hash, fnum => 2, rnum => 3, type => uint32,
     ...
     #{name => compact_revision, fnum => 3, rnum => 4,
       type => int64, occurrence => optional, opts => []}];
find_msg_def('eetcd.HashResponse') ->
    [#{name => header, fnum => 1, rnum => 2,
       type => {msg, 'eetcd.ResponseHeader'},
       occurrence => optional, opts => []},
     #{name => hash, fnum => 2, rnum => 3, type => uint32,
       occurrence => optional, opts => []}];
find_msg_def('eetcd.KeyValue') ->
    [#{name => key, fnum => 1, rnum => 2, type => bytes,
       occurrence => optional, opts => []},
     #{name => create_revision, fnum => 2, rnum => 3,
       type => int64, occurrence => optional, opts => []},
...
find_enum_def('eetcd.Event.EventType') ->
    [{'PUT', 0}, {'DELETE', 1}];
...
enum_symbol_by_value('eetcd.Event.EventType', Value) ->
    'enum_symbol_by_value_eetcd.Event.EventType'(Value);
...
enum_value_by_symbol('eetcd.Event.EventType', Sym) ->
    'enum_value_by_symbol_eetcd.Event.EventType'(Sym);
...
'enum_symbol_by_value_eetcd.Event.EventType'(0) ->
    'PUT';
'enum_symbol_by_value_eetcd.Event.EventType'(1) ->
    'DELETE'.


'enum_value_by_symbol_eetcd.Event.EventType'('PUT') ->
    0;
'enum_value_by_symbol_eetcd.Event.EventType'('DELETE') ->
    1.
...
fqbin_to_msg_name(<<"eetcd.ResponseHeader">>) -> 'eetcd.ResponseHeader';
fqbin_to_msg_name(<<"eetcd.HashRequest">>) -> 'eetcd.HashRequest';
fqbin_to_msg_name(<<"eetcd.HashKVRequest">>) -> 'eetcd.HashKVRequest';
fqbin_to_msg_name(<<"eetcd.HashKVResponse">>) -> 'eetcd.HashKVResponse';
fqbin_to_msg_name(<<"eetcd.HashResponse">>) -> 'eetcd.HashResponse';
fqbin_to_msg_name(<<"eetcd.KeyValue">>) -> 'eetcd.KeyValue';
fqbin_to_msg_name(<<"eetcd.Event">>) -> 'eetcd.Event';
...
msg_name_to_fqbin('eetcd.ResponseHeader') -> <<"eetcd.ResponseHeader">>;
msg_name_to_fqbin('eetcd.HashRequest') -> <<"eetcd.HashRequest">>;
msg_name_to_fqbin('eetcd.HashKVRequest') -> <<"eetcd.HashKVRequest">>;
msg_name_to_fqbin('eetcd.HashKVResponse') -> <<"eetcd.HashKVResponse">>;
msg_name_to_fqbin('eetcd.HashResponse') -> <<"eetcd.HashResponse">>;
msg_name_to_fqbin('eetcd.KeyValue') -> <<"eetcd.KeyValue">>;
msg_name_to_fqbin('eetcd.Event') -> <<"eetcd.Event">>;
...
fqbin_to_enum_name(<<"eetcd.Event.EventType">>) -> 'eetcd.Event.EventType';
...
enum_name_to_fqbin('eetcd.Event.EventType') -> <<"eetcd.Event.EventType">>;
...
source_basename() -> "essentials.proto".
...
get_all_source_basenames() ->
    ["essentials.proto", "gogo.proto", "descriptor.proto"].
...
%% functions.
get_all_proto_names() ->
    ["essentials", "gogo", "descriptor"].


get_msg_containment("essentials") ->
    ['eetcd.Event', 'eetcd.HashKVRequest',
     'eetcd.HashKVResponse', 'eetcd.HashRequest',
     'eetcd.HashResponse', 'eetcd.KeyValue',
     'eetcd.ResponseHeader'];
...
get_pkg_containment("essentials") -> eetcd;
...
get_service_containment("essentials") -> [];
...
get_rpc_containment("essentials") -> [];
...
get_enum_containment("essentials") ->
    ['eetcd.Event.EventType'];
...
get_proto_by_msg_name_as_fqbin(<<"eetcd.ResponseHeader">>) -> "essentials";
...
get_proto_by_msg_name_as_fqbin(<<"eetcd.HashRequest">>) -> "essentials";
get_proto_by_msg_name_as_fqbin(<<"eetcd.HashKVRequest">>) -> "essentials";
get_proto_by_msg_name_as_fqbin(<<"eetcd.Event">>) -> "essentials";
...
get_proto_by_msg_name_as_fqbin(<<"eetcd.KeyValue">>) -> "essentials";
get_proto_by_msg_name_as_fqbin(<<"eetcd.HashResponse">>) -> "essentials";
get_proto_by_msg_name_as_fqbin(<<"eetcd.HashKVResponse">>) -> "essentials";
...
get_proto_by_enum_name_as_fqbin(<<"google.protobuf.FieldDescriptorProto.Type">>) ->
    "descriptor";
get_proto_by_enum_name_as_fqbin(<<"eetcd.Event.EventType">>) ->
    "essentials";
...
get_protos_by_pkg_name_as_fqbin(<<"eetcd">>) ->
    ["essentials"];
