...
-type 'mvccpb.KeyValue'() ::
      #{key                     => iodata(),        % = 1
        create_revision         => integer(),       % = 2, 64 bits
        mod_revision            => integer(),       % = 3, 64 bits
        version                 => integer(),       % = 4, 64 bits
        value                   => iodata(),        % = 5
        lease                   => integer()        % = 6, 64 bits
       }.
...
get_all_source_basenames() ->
    ["kv.proto", "gogo.proto", "descriptor.proto"].
...
%% functions.
get_all_proto_names() -> ["kv", "gogo", "descriptor"].
